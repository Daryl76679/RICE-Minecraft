...
public class RiceBlock extends RiceModElements.ModElement {
	@ObjectHolder("rice:rice")
	public static final Block block = null;

	public RiceBlock(RiceModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rice"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rice:rice"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blocks.AIR, (int) (3)));
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			RiceAdditionalGenerationConditionProcedure.executeProcedure(Stream
