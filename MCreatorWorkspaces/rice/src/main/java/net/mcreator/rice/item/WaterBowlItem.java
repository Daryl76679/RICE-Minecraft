...
public class WaterBowlItem extends RiceModElements.ModElement {
	@ObjectHolder("rice:water_bowl")
	public static final Item block = null;

	public WaterBowlItem(RiceModElements instance) {
		super(instance, 63);
	}
