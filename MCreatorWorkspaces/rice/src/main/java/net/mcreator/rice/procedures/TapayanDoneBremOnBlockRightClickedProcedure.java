...
public class TapayanDoneBremOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.GLASS_BOTTLE) {
			if (entity instanceof LivingEntity _entity) {
				ItemStack _setstack = new ItemStack(RiceModItems.BREM.get());
			...
			}
			{
				...
				BlockState _bs = RiceModBlocks.TAPAYAN.get().defaultBlockState();
