...
public class RiceSproutUpdateTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RiceMod.LOGGER.warn("Failed to load dependency world for procedure RiceSproutUpdateTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RiceMod.LOGGER.warn("Failed to load dependency x for procedure RiceSproutUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RiceMod.LOGGER.warn("Failed to load dependency y for procedure RiceSproutUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RiceMod.LOGGER.warn("Failed to load dependency z for procedure RiceSproutUpdateTick!");
			return;
		}
		...
		}.getValue(world, new BlockPos(x, y, z), "TotalGrowthTime") == 9000) {
			{
				BlockPos _bp = new BlockPos(x, y, z);
				BlockState _bs = RiceSproutSecondStateBlock.block.getDefaultState();
