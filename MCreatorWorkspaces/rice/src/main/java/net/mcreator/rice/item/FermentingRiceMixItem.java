...
public class FermentingRiceMixItem extends RiceModElements.ModElement {
	@ObjectHolder("rice:fermenting_rice_mix")
	public static final Item block = null;

	public FermentingRiceMixItem(RiceModElements instance) {
		super(instance, 94);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fermenting_rice_mix");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			FermentingRiceMixRightclickedOnBlockProcedure.executeProcedure(Stream
