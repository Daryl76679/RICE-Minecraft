...
public class RiceBowlItem extends RiceModElements.ModElement {
	@ObjectHolder("rice:rice_bowl")
	public static final Item block = null;

	public RiceBowlItem(RiceModElements instance) {
		super(instance, 64);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(11).saturation(4f)
