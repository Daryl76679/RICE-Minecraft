...
public class UnprocessedRiceItem extends RiceModElements.ModElement {
	@ObjectHolder("rice:unprocessed_rice")
	public static final Item block = null;

	public UnprocessedRiceItem(RiceModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("unprocessed_rice");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			UnprocessedRiceRightClickedOnBlockProcedure.executeProcedure(Stream
