	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RiceMod.LOGGER.warn("Failed to load dependency world for procedure Grow3!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RiceMod.LOGGER.warn("Failed to load dependency x for procedure Grow3!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RiceMod.LOGGER.warn("Failed to load dependency y for procedure Grow3!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RiceMod.LOGGER.warn("Failed to load dependency z for procedure Grow3!");
			return;
		}
		...
		if (new Object() {
			...
			{
				BlockPos _bp = new BlockPos(x, y, z);
				BlockState _bs = CultivatedRiceBaseBlock.block.getDefaultState();
		...
		if (!(new Object() {
			...
			if (!((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == RiceSproutTopBlock.block)) {
				if (world instanceof World) {
